...
def home_page(request):
    ...
    prothom_alo_all_news_link = news_paper.objects.filter(news_paper_name = 'prothomAlo').values( 'news_title', 'news_link', 'publication_time').order_by('-publication_time')[:15]
    ittefak_all_news_link = news_paper.objects.filter(news_paper_name = 'ittefak').values( 'news_title', 'news_link', 'publication_time').order_by('-publication_time')[:15]
    jugantor_all_news_link = news_paper.objects.filter(news_paper_name = 'jugantor').values( 'news_title', 'news_link', 'publication_time').order_by('-publication_time')[:15]
    banglaNews24_all_news_link = news_paper.objects.filter(news_paper_name = 'banglaNews24').values( 'news_title', 'news_link', 'publication_time').order_by('-publication_time')[:15]
